...
class DarkThemeData {
  ThemeData get themeData {
    var mainColor = const Color.fromARGB(255, 39, 41, 47);
    var highlightColor = const Color.fromARGB(255, 78, 173, 171);
    var textColor = const Color.fromARGB(255, 253, 253, 254);
